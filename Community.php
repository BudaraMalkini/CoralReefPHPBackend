    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li>
            <a class="nav-link scrollto" href="Why coral Reef.php">Why Coral Reef</a>
          </li>
          <li class="dropdown">
          ...
          <li class="dropdown">
            ...
            <ul>
              <li><a href="https://corabarrier.herokuapp.com/">Prediction</a></li>
              <li><a href="News.php">News</a></li>
              <li>
                <a class="nav-link scrollto active" href="Community.php">Coral Reef Community</a>
              </li>
            </ul>
          </li>
        </ul>
            ...
            <form action="addPost.php" method="post" role="form" enctype="multipart/form-data">
              <div class="post">
                <div class="form-group mt-3">
                  <textarea class="form-control" name="message" rows="5" placeholder="Add new Post" style="border: none"></textarea>
              ...
              <div class="card2">
                <div class="comment">
                  <div class="nav-profile d-flex align-items-center">
                    ...
                    ?>
                    <img src="<?php echo $row1['profile_pic'] ?>" ; alt="Profile" class="rounded-circle" style="max-height:75px;width:20%px" />
                  ...
                  <form method="post" action="addComment.php">
                    ...
                    <div class="input-group">
                      <input type="text" placeholder="write a comment" style="width:90%" name="comment" />
                  ...
                  ?>
                    <div class="usercommet">
                      <div class="nav-profile d-flex align-items-center">
                        <img src="<?php echo $row2['profile_pic']; ?>" alt="Profile" class="rounded-circle" style="max-height:75px;width:20%px" />
